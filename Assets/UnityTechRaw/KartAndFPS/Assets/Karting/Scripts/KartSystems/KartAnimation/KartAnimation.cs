using System;
using UnityEngine;
using UnityTechRaw.KartAndFPS.Assets.Karting.Scripts.KartSystems.Inputs;
using UnityTechRaw.KartAndFPS.Assets.Karting.Scripts.KartSystems.KartMovement;
using UnityTechRaw.KartAndFPS.Assets.Karting.Scripts.Utilities;
using Object = UnityEngine.Object;

namespace UnityTechRaw.KartAndFPS.Assets.Karting.Scripts.KartSystems.KartAnimation
{
    /// <summary>
