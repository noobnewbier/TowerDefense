...
namespace UnityTechRaw.KartAndFPS.Assets.Karting.Scripts.KartSystems.KartMovement.Editor
{
    /// <summary>
    /// Editor for the KartMovement MonoBehaviour.
    /// </summary>
    [CustomEditor (typeof(KartMovement))] public class KartMovementEditor : UnityEditor.Editor
    {
