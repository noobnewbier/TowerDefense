using UnityEngine;
using UnityTechRaw.KartAndFPS.Assets.Scripts.TowerDefense.Agents;
using UnityTechRaw.KartAndFPS.Assets.Scripts.TowerDefense.MeshCreator;

namespace UnityTechRaw.KartAndFPS.Assets.Scripts.TowerDefense.Nodes
{
	/// <summary>
